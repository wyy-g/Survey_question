...
import { QuestionDateScopePropsType, QUestionDateScopeDefaultProps, formatType } from './interface'

const PropComponent: FC<QuestionDateScopePropsType> = (props: QuestionDateScopePropsType) => {
